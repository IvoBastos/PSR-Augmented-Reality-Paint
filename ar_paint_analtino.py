...
def main():
    ...
    paint_load_flag = False  # paint load flag
    ...
    parser.add_argument("-paint", "--paint_load", type=str, required=True, help="Full path to png file")
    ...
    if paint_load_flag:
        cv2.namedWindow("paint_load")  # create window for the image
    ...
    while True:
        ...
        # show the Paint loaded if True
        if paint_load_flag:
            cv2.imshow("image load", paint_load)
